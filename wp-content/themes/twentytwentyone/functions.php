...
function custom_shop_order_column($columns)
{
    ...
    foreach( $columns as $key => $column){
        ...
        if( $key ==  'order_status' ){
            ...
            $reordered_columns['my-column1'] = __( 'admin_order_status','theme_domain');
...
function custom_orders_list_column_content( $column, $post_id )
{
    switch ( $column )
    {
        case 'my-column1' :
            ...
            $my_var_one = get_post_meta( $post_id, 'order_status', true );
            if(!empty($my_var_one))
                print_r($my_var_one);
...
add_shortcode( 'mysho', 'myshort' );

function wpb_demo_shortcode() { 
 
// Things that you want to do. 
$message = the_field('myho'); 
